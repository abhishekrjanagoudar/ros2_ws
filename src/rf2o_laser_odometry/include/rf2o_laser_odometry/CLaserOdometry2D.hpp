...
public:
  ...
  CLaserOdometry2D(const std::string& node_name = "rf2o");

  std::string node_name_;
  rclcpp::Logger get_logger() { return rclcpp::get_logger(node_name_); }
  ...
  // Quality metrics for solution validation
  float last_aver_residual_;
